...
const ReservaCupo = () => {
  ...
  const { userData } = useAuth(); // Obtener datos del usuario desde contexto
  ...
  // Autocompletar campos cuando userData esté listo
  useEffect(() => {
    if (userData) {
      setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Enviar datos completos, asegurando enviar los datos del usuario autenticado
      ...
      if (data.ok) {
        ...
        // Opcional: dejar los datos para no perderlos o resetear si prefieres
      ...
      <div className={FormStyles.container}>
        ...
        <form onSubmit={handleSubmit} className={FormStyles.form}>
          <input
            ...
            disabled // Deshabilitado para que no modifique nombres autocompletados
          />
          <input
            type="text"
            name="apellidos"
