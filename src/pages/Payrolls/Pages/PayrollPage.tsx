...
function PayrollMain() {
  ...
  return (
    <div className="p-4 space-y-6 max-w-4xl mx-auto">
      ...
      <p>
        Esta sección muestra el valor estimado del Décimo Tercer Sueldo para cada docente que cumple con los requisitos para recibirlo.
      </p>
      <p>
        El décimo tercer sueldo se calcula tomando la doceava parte de todos los
        ingresos registrados desde el {" "}
        <strong>1 de diciembre de {endDate14to().lastYear}</strong> (año anterior) {" "}
        <strong>hasta el 30 de noviembre de {endDate14to().currentYear}</strong> (año actual). {" "}
      ...
      <p>
        ...
        <strong>Sueldo Básico Unificado (SBU)</strong> vigente en Ecuador hasta
        la fecha de pago.
      </p>
      <p>
      ...
      <div className="flex items-start gap-4 bg-yellow-50 border border-yellow-500 rounded-2xl p-4 text-gray-700">
        ...
        <p>
          Este es un valor aproximado, teniendo en cuenta que todos los docentes
          asalariados han trabajado durante todo el año estipulado para el
          régimen sierra:{" "}
          <strong>
